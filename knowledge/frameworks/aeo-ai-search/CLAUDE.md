...
| Build backlinks | Build **citations** |
| Long-form content | **Atomic facts** per sentence |
| Keyword in title | **Information Gain** (novelty) |
| Generic authority | **Entity Home** + Knowledge Graph |

## Related Files

- `channels/seo-content.md` - Traditional SEO content guide
- `checklists/seo-checklist.md` - SEO validation checklist
