...
### One-line claim
Plan and produce a complete product launch marketing package - landing page copy, email sequences, ad campaigns, press release, social posts, and launch timeline. Orchestrates all other kai skills into a coordinated launch.
...
- `launch_subject` (string, required) - product, feature, update, offer, or campaign being launched.
- `launch_date` (date, required) - timeline anchor for phases and assets.
...
### Outputs
- Artifact -> `workspace/launch/` timeline, messaging guide, page copy, emails, ads, blog, PR, social, LinkedIn, monitoring plan, and quality report.
...
### Example artifacts
- [launch timeline](../../workspace/launch/_timeline.md)
- [messaging guide](../../workspace/launch/_messaging-guide.md)
