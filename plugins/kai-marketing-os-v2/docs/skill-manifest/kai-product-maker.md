...
### One-line claim
Build a Gumroad-ready digital product from scratch - ebook, card deck, playbook, Notion template, or flipbook. Walks from concept -> content outline -> design brief -> per-item markdown -> images -> multi-format build (PDF, HTML flipbook, Notion, card deck) -> Gumroad sales page + email blast + launch assets.
...
### Outputs
- Artifact -> digital product package with product brief, content files, image plan, build prompt, sales page, launch emails, and package checklist.
...
### Competitive claim
This skill differs from generic marketing AI by preparing reusable marketing context and runtime state that later skills consume.
