...
### One-line claim
Customer retention system - churn analysis, retention tactics, loyalty programs, and engagement scoring.
...
### Outputs
- Artifact -> retention system with churn diagnostics, engagement scoring, playbook, win-back campaign, loyalty/dunning notes.
...
### Example artifacts
- [weekly signal report email](../../workspace/demo-clients/northstar-media-lab/emails/retention/weekly-signal-report.md)
- [new creative angle email](../../workspace/demo-clients/northstar-media-lab/emails/retention/new-creative-angle.md)
- [referral ask email](../../workspace/demo-clients/northstar-media-lab/emails/retention/referral-ask.md)
