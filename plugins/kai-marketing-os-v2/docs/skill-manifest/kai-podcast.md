...
### One-line claim
Launch a podcast or plan podcast guest strategy - format, content planning, episode production, guest outreach, and distribution.
...
### Outputs
- Artifact -> podcast launch plan or guest strategy with format, content map, outreach, distribution, and repurposing notes.
