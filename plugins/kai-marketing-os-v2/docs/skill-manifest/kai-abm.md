...
### One-line claim
Plan and execute account-based marketing campaigns for enterprise targets - account selection, personalized outreach, multi-channel touch sequences, and deal acceleration.
...
### Outputs
- Artifact -> account-tier plan, account dossiers, buying-committee map, touch sequence, ad/message variants, and measurement plan.
