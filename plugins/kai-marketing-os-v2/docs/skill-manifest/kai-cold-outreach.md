...
### One-line claim
Build a complete cold email outreach system - ICP definition, sequence architecture, personalization strategy, and batch-produced email sequences with CAN-SPAM/deliverability compliance.
...
### Outputs
- Artifact -> `workspace/outreach/` sequence map, deliverability notes, personalization guide, and email touches.
