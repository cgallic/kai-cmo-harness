...
| `/kai-audit`, CRO audits | Openness finding: recommend accurate/extended hours and call answering; pairs with the Phone Capture Fit Rule for phone-led businesses (missed calls now interact with LSA call-quality evaluation and shrinking call buttons). Compare phone answering options and name no vendor by default. |
