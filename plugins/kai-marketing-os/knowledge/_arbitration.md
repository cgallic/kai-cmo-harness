...
| **Local services (phone-led)** | `playbooks/local-seo-gbp-optimization.md` · `people/tommy-mello-knowledge.md` (speed-to-lead, CSR booking) · `people/joy-hawkins-knowledge.md` + `people/darren-shaw-knowledge.md` (local ranking factors) · `playbooks/conversion-rate-optimization.md` | `people/local-dominance-strategy.md` · `knowledge/checklists/cro-audit-checklist.md` · `people/dan-kennedy-knowledge.md` (offer + follow-up) · `channels/paid-acquisition.md` (LSAs) — Phone Capture Fit Rule per `AGENTS.md` at recommendation time |
