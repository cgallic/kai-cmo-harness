...
### One-line claim
Competitive intelligence teardown - 5-layer analysis (signals, product, marketing, positioning, strategy) plus sales battlecard.
...
### Outputs
- Artifact -> competitive teardown, matrix, positioning notes, and sales battlecard.
...
### Example artifacts
- [competitive intelligence reassessment](../competitive-intelligence-reassessment.md)
- [competitive review prompt](../competitive-review-prompt.md)
