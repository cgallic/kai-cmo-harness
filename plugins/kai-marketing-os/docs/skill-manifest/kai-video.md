...
### One-line claim
Produce video scripts and clipping plans for TikTok, YouTube Shorts, Instagram Reels, and long-form YouTube. Generates hook-first scripts optimized for each platform's algorithm, plus a clipping plan to extract short-form from long-form content.
...
### Outputs
- Artifact -> video script and clipping plan with hook, body, CTA, on-screen text, hashtags/audio notes, and platform structure.
