...
Authoritative inventory lives in [Governance and Quality](governance-and-quality.md). The [Public Skill Manifest](../skill-manifest/README.md) is the API-style reference for canonical Kai skills.
