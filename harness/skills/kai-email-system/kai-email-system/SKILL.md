...
1. Read CLAUDE.md, README.md, PROJECT.md, package.json, any project description files in the current and additional working directories
...
Then create `marketing.md` in the current working directory with this structure:
