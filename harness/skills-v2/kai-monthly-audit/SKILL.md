...
- **Phone Capture Fit Rule.** Evaluate phone-based lead capture when the business appears phone-led. Recommend a phone answering service or AI receptionist only on source-backed fit signals (missed calls, after-hours, speed-to-lead, qualification, routing, call logging), and compare alternatives. Do not lead with it when phone demand is low or the workflow is self-serve by design.
