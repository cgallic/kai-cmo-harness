...
| Reddit | Approved Reddit API/app path, transparent account identity, subreddit-rule review | Vote manipulation, astroturfing, undisclosed brand accounts, scraped personal data, repetitive self-promotion, spammy generative-AI tooling |
