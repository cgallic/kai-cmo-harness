...
### One-line claim
Plan webinar and event marketing - topic selection, promotion strategy, content production, registration flow, and post-event follow-up sequences.
...
### Outputs
- Artifact -> webinar/event package with topic, registration page copy, promotion sequence, run-of-show, and post-event follow-up.
