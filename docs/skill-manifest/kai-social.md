...
### One-line claim
Plan and batch-produce social media content across platforms (Instagram, X/Twitter, TikTok, LinkedIn, YouTube). Generates a week or month of posts with platform-specific formatting, hashtags, hooks, and posting schedule.
...
### Outputs
- Artifact -> `workspace/social/_calendar.md` social calendar, platform-native posts, hashtags, visual direction, and posting notes.
...
### Example artifacts
- [launch-day social posts](../../workspace/launch/social/launch-day-posts.md)
- [teaser posts](../../workspace/launch/social/teaser-posts.md)
- [sustain posts](../../workspace/launch/social/sustain-posts.md)
