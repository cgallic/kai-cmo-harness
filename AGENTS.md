...
This file is the entry point. Codex reads it automatically and gains access to 30+ frameworks, 17 checklists, 8 audience personas, and a quality gate pipeline that enforces standards before anything ships.
...
For any `kai-surround-sound`, `kai-seo-audit`, or site-level AEO engagement, audit the target domain against the **agent-readiness checklist** before planning outbound work. If the target site isn't legible to ChatGPT / Codex / Perplexity, surround-sound spend dead-ends.
